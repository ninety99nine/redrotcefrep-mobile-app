...
const List mobileNumberStartsWith = ['71', '72', '73', '74', '75', '76', '77'];
const String apiHomeUrl = 'http://127.0.0.1:8000/api/v1';   //  'http://167.99.252.212/api/v1'; // 'http://165.232.179.255/api/v1'; //  
