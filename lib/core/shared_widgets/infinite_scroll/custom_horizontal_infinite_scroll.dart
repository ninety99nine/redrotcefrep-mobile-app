...
class CustomHorizontalInfiniteScroll extends StatefulWidget {
  ...
  const CustomHorizontalInfiniteScroll({
    Key? key,
    this.margin,
    this.onPageChanged,
    this.initialPage = 0,
  ...
  @override
  State<CustomHorizontalInfiniteScroll> createState() => CustomHorizontalInfiniteScrollState();
}

class CustomHorizontalInfiniteScrollState extends State<CustomHorizontalInfiniteScroll> {
