...
class TeamMemberInvitationsInVerticalInfiniteScroll extends StatefulWidget {
  ...
  const TeamMemberInvitationsInVerticalInfiniteScroll({
    super.key,
    this.isAcceptingAll,
    this.isDecliningAll,
  ...
  @override
  State<TeamMemberInvitationsInVerticalInfiniteScroll> createState() => _TeamMemberInvitationsInVerticalInfiniteScrollState();
}

class _TeamMemberInvitationsInVerticalInfiniteScrollState extends State<TeamMemberInvitationsInVerticalInfiniteScroll> {
