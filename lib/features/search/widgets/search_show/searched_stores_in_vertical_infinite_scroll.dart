...
import '../../../stores/widgets/store_card/primary_section_content/logo.dart';
...
class SearchedStoresInVerticalInfiniteScroll extends StatefulWidget {
  
  final String searchWord;
  final Function(bool) onSearching;
  final Function(ShoppableStore) onSelectedStore;

  const SearchedStoresInVerticalInfiniteScroll({
    super.key,
  ...
  @override
  State<SearchedStoresInVerticalInfiniteScroll> createState() => _SearchedStoresInVerticalInfiniteScrollState();
}

class _SearchedStoresInVerticalInfiniteScrollState extends State<SearchedStoresInVerticalInfiniteScroll> {
