...
class SearchedFriendsInVerticalInfiniteScroll extends StatefulWidget {
    
  final String searchWord;
  final Function(bool) onSearching;
  final Function(User) onSelectedFriend;

  const SearchedFriendsInVerticalInfiniteScroll({
    super.key,
  ...
  @override
  State<SearchedFriendsInVerticalInfiniteScroll> createState() => _SearchedFriendsInVerticalInfiniteScrollState();
}

class _SearchedFriendsInVerticalInfiniteScrollState extends State<SearchedFriendsInVerticalInfiniteScroll> {
