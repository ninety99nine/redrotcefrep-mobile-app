...
class SearchedFriendGroupsInVerticalInfiniteScroll extends StatefulWidget {
  
  final String searchWord;
  final Function(bool) onSearching;
  final Function(FriendGroup) onSelectedFriendGroup;

  const SearchedFriendGroupsInVerticalInfiniteScroll({
    super.key,
  ...
  @override
  State<SearchedFriendGroupsInVerticalInfiniteScroll> createState() => _SearchedFriendGroupsInVerticalInfiniteScrollState();
}

class _SearchedFriendGroupsInVerticalInfiniteScrollState extends State<SearchedFriendGroupsInVerticalInfiniteScroll> {
