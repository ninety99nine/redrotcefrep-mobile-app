...
class OrderCollectionContent extends StatefulWidget {
  
  final Order order;
  final Function(Order)? onUpdatedOrder;

  const OrderCollectionContent({
    Key? key,
    required this.order,
    this.onUpdatedOrder
  }) : super(key: key);
  ...
  @override
  State<OrderCollectionContent> createState() => OrderCollectionContentState();
}

class OrderCollectionContentState extends State<OrderCollectionContent> {
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: isLoading ? [
                      ...
                      OrderCollectionBuyerConfirmation(order: order, imageHeight: 250, autoShowCollectionCode: true),
                      
                      /// Order Collection Seller Confirmation 
                      OrderCollectionSellerConfirmation(order: order, imageHeight: 250, autoShowQRScanner: true, onUpdatedOrderStatus: _onUpdatedOrder),
