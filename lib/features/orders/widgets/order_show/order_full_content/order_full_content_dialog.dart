...
class OrderFullContentDialog extends StatefulWidget {

  final Order order;
  final Function(Order)? onUpdatedOrder;

  const OrderFullContentDialog({
    super.key,
    required this.order,
    this.onUpdatedOrder,
  });
  ...
  @override
  State<OrderFullContentDialog> createState() => _OrderRequestPaymentDialogState();
}

class _OrderRequestPaymentDialogState extends State<OrderFullContentDialog> {
                ...
                children: [
                  ...
                  Expanded(
                    child: SingleChildScrollView(
                      child: OrderFullContent(order: order, onUpdatedOrder: onUpdatedOrder)
                    )
                  ),
