...
class OrdersInVerticalInfiniteScroll extends StatefulWidget {
  ...
  const OrdersInVerticalInfiniteScroll({
    Key? key,
    this.order,
    required this.store,
  ...
  @override
  State<OrdersInVerticalInfiniteScroll> createState() => OrdersInVerticalInfiniteScrollState();
}

class OrdersInVerticalInfiniteScrollState extends State<OrdersInVerticalInfiniteScroll> {
  ...
  @override
  void didUpdateWidget(covariant OrdersInVerticalInfiniteScroll oldWidget) {
    ...
    if(orderFilter != oldWidget.orderFilter) {
      ...
      /// Scroll to top
      _customVerticalInfiniteScrollState.currentState!.controller.animateTo( 
        0,
...
class _OrderItemState extends State<OrderItem> {
  ...
  void onRequestedOrderRelationships (Order order) {
    ...
    if(orderIndex >= 0) {
      ...
      widget.customVerticalInfiniteScrollState.currentState!.updateItemAt(orderIndex, order);
    ...
    return Dismissible(
      ...
      onDismissed: (DismissDirection direction) {
        ...
        if(totalItemsLeft == 0) {
          ...
          widget.customVerticalInfiniteScrollState.currentState!.startRequest();
      ...
      child: ListTile(
          ...
          onTap: () {
            ...
            if(isViewingOrder) {
              ...
              widget.customVerticalInfiniteScrollState.currentState!.controller.animateTo( 
                0,
                curve:Curves.fastOutSlowIn,
          ...
          title: Column(
            ...
            children: [
              ...
              /// If we are viewing mulitple orders (show the following widgets)
              if(isViewingOrders) ...[

                /// Display name
                CustomTitleMediumText(widget.order.attributes.customerName),
