...
class CreatedStoresContent extends StatefulWidget {
  const CreatedStoresContent({super.key});

  @override
  State<CreatedStoresContent> createState() => CreatedStoresContentState();
}

class CreatedStoresContentState extends State<CreatedStoresContent> {
