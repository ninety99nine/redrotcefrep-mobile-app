...
class AssignedStoresContent extends StatefulWidget {
  const AssignedStoresContent({super.key});

  @override
  State<AssignedStoresContent> createState() => AssignedStoresContentState();
}

class AssignedStoresContentState extends State<AssignedStoresContent> {
